			...
			if(mysqli_num_rows($sql)>=0)
			{
				while($row = mysqli_fetch_assoc($sql))
				{
					...
					echo '<div class="department"><div class="card"><p><img src="../images/'.$row['dimage'].'"style="width:100%; height:100%;"><br><b><center>Dr. '.$row['name'].'</center></b>
						  <br><a class="abutton" onclick="edittextbox()">EDIT</a></p><p><a href="admindocappointment.php?docid='.$row['docid'].'" class="abutton">APPOINTMENTS</a></p></div>';
					echo '<div class="docdetails"><form method="POST" action="updatedocdetails.php?did='.$id.'"><table style="font-size:18px;">
...
?>
  ...
  <a class="cancelbtn" href="../php/viewdoctor.php">CANCEL</a></center>
  </form>
</div>
</div>
<script>
